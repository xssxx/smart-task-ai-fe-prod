        ...
        <Card className="bg-white/80 backdrop-blur-lg border-white/20 shadow-2xl rounded-3xl overflow-hidden p-0 gap-0">
          ...
          <CardContent className="px-6 py-5">
            ...
            <Button
              onClick={signIn}
              disabled={isLoading}
              className="w-full h-10 bg-linear-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all group disabled:opacity-70"
            >
              {isLoading ? (
                <>
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              <Button
                ...
                className="h-9 rounded-lg disabled:opacity-70"
              >
                {isGoogleLoading ? (
